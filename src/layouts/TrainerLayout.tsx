...
export const TrainerLayout: React.FC = () => {
  ...
  const navigationItems = [
    ...
    { label: 'Create Course', path: '/trainer/courses/create', icon: PlusCircle },
    { label: 'Questionnaires', path: '/trainer/questionnaires', icon: FileQuestion },
    { label: 'Trainees Mentored', path: '/trainer/trainees', icon: Users },
    { label: 'Performance', path: '/trainer/performance', icon: TrendingUp },
    { label: 'Trainer Library', path: '/trainer/library', icon: FolderOpen },
    { label: 'Analytics', path: '/trainer/analytics', icon: BarChart3 },
    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#0F172A] flex flex-col md:flex-row antialiased">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-[#E7E5E4] p-6 sticky top-0 h-screen z-30">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <span className="text-[10px] text-[#2A7F7E] uppercase font-mono font-bold tracking-wider block">Trainer Console</span>
          </div>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-[#FAF8F5] border border-[#E7E5E4] mb-6 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[10px] text-[#64748B] truncate">Faculty Expert</p>
          </div>
        </div>
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-white border-b border-[#E7E5E4] sticky top-0 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif font-bold text-sm text-[#0F172A]">Trainer Portal</span>
        </div>
        <button
          ...
          <div className="w-72 bg-white h-full p-6 flex flex-col justify-between shadow-2xl">
            <div>
              <div className="flex items-center justify-between mb-6">
                <span className="font-serif font-bold text-sm text-[#0F172A]">Trainer Navigation</span>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="hidden md:flex items-center justify-between px-8 py-4 bg-white border-b border-[#E7E5E4] sticky top-0 z-20">
          <div className="flex items-center gap-2 text-xs text-[#64748B]">
            ...
            <span className="font-mono uppercase tracking-wider font-semibold text-[#0D3B66]">Trainer & Faculty Portal</span>
            <span>•</span>
            <span>IMD National Forecasting Centre</span>
          </div>
